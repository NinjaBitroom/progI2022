...
ibagem = document.querySelector('#imagem img')
ibagem.onmouseover = function() {
    ibagem.src = 'imagens/mqdefault.jpg'
}
ibagem.onmouseout = function() {
    ibagem.src = 'imagens/salao.jfif'
}
